...
#+STARTUP: overview
#+PROPERTY: header-args:emacs-lisp :tangle ./init.el :mkdirp yes :eval t
...
#+begin_src emacs-lisp :eval never-export :results silent
  (use-package help
    ...
    (use-package helpful
     :custom
     ;; (counsel-describe-function-function #'helpful-callable) ; TODO replace with corfu
