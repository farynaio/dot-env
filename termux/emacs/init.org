...
TODO:
- [ ] https://codeberg.org/MonadicSheep/emacs-reader :: nov alternative
- [ ] https://mutagen.io/ :: "cloud based development using local tools". Can I use remote docker like local on Termux?
- [ ] check ghostel
