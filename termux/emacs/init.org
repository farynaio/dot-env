...
- [X] Android make mouse2 click on elfeed-search not open entey, just move cursor only
...
- [X] https://github.com/magnars/emacsd-reboot/blob/main/settings/buffers.el
- [X] https://github.com/magnars/emacsd-reboot/blob/main/settings/editing.el
- [X] https://github.com/magnars/emacsd-reboot/blob/main/packages/setup-org-mode.el my/org-update-parent-cookie
- [X] https://github.com/magnars/emacsd-reboot/blob/main/settings/navigation.el
