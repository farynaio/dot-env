...
(when (my/termux-p)
  ...
  (defun my/kill-to-clipboard ()
    ...
    (call-process "termux-clipboard-set" nil nil nil
                  (current-kill 0 t))
    (message "Copied kill ring to clipboard"))

  ;; TODO: this can be adapted for use outside Termux with xclip, and moved to 'org' section
  (defun my/org-copy-link ()
    ...
    (let* ((context (org-element-context))
      ...
      (if (eq type 'link)
          (progn
            (my/termux-clipboard-region beg end)
  ...
  (pretty-hydra-define hydra-base
    ...
    (""
     ...
     (("a" org-agenda "org-agenda")
      ...
      ("C" my/kill-to-clipboard "kill to clipboard")
      ("y" my/termux-clipboard-paste "paste clipboard")
...
(use-package org
  ...
  (when (my/termux-p)
    (define-key org-mode-map (kbd "RET") 'my/org-copy-link))
