...
(use-package counsel
  ...
  (defun my/counsel-grep-at-point-plain ()
    ...
    (let ((w (thing-at-point 'symbol t)))
      (counsel-grep-or-swiper (or w nil))))
...
should be continued."
  ...
  (defadvice org-kill-line (after fix-cookies activate) (my/org-update-parent-cookie))
  (defadvice kill-whole-line (after fix-cookies activate) (my/org-update-parent-cookie)))
