...
(defvar my/org-roam-dir (expand-file-name "~/my-roam"))
...
(use-package org-roam
  ...
  :preface (unless (file-exists-p my/org-roam-dir) (warn (concat "org-roam: 'my/org-roam-dir' not set, default folder will be used " org-roam-directory)))
