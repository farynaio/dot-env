...
(setq my/fast-path (expand-file-name "others" "~/Documents/Cloud/org-agenda-repo"))
(setq org-agenda-directory (expand-file-name "agenda" "~/Documents/Cloud/org-agenda-repo"))
...
(setq my/whonix-share-file-path (expand-file-name "share.txt" "~/Virtual Machines/shared/whonix-desktop"))
