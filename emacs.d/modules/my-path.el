...
(setq my/fast-path (expand-file-name "others" "~/Documents/Nextcloud/org-agenda-repo"))
(setq org-agenda-directory (expand-file-name "agenda" "~/Documents/Nextcloud/org-agenda-repo"))
...
(setq my/org-media-reviews-file-path (expand-file-name "media-reviews.org" org-directory))
