...
(use-package prog-mode
  ...
  (major-mode-hydra-define (prog-mode ruby-mode web-mode markdown-mode yaml-mode json-mode conf-toml-mode rjsx-mode typescript-mode typescript-ts-mode tsx-ts-mode)
