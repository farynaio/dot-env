...
(register-definition-prefixes "circe" '("circe-" "lui-logging-format-arguments" "with-circe-server-buffer"))
...
If called interactively, toggle `Circe-lagmon mode'.  If the
...
If called interactively, toggle `Tracking mode'.  If the prefix
